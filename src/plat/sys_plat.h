...
// 不同网卡配置，共2块网卡
#if 1
static const char netdev0_ip[] = "172.16.191.1";
static const char netdev0_gw[] = "192.168.74.1";
static const char friend0_ip[] = "192.168.0.14";
static const char netdev0_phy_ip[] = "172.16.191.1";    // 用于收发包的真实网卡ip地址，在qemu上不需要使用
static const char netdev0_mask[] = "255.255.255.0";
static const uint8_t netdev0_hwaddr[] = { 0x00, 0x0c, 0x29, 0x9c, 0x84, 0x78  };
#else
